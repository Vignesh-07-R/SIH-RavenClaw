...
# Sensor columns per the current data/engine_data_generator.py output
# (Rotax 912-class synthetic dataset). fault_mode and RUL are labels,
# never fed in as features.
SENSOR_COLUMNS = [
